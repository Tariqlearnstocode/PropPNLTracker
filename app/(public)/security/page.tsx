    ...
    <div className="min-h-screen bg-terminal-bg">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-terminal-card rounded-xl border border-terminal-border p-8 md:p-12">
          ...
          <h1 className="text-3xl font-bold text-terminal-text mb-2">Security & Privacy Policy</h1>
          <p className="text-terminal-muted text-sm mb-8">Last updated: January 8, 2026</p>

          <hr className="border-terminal-border mb-8" />

          <p className="text-terminal-text leading-relaxed mb-8">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">1. Data Protection</h2>

            <h3 className="font-medium text-terminal-text mb-2">1.1 Encryption</h3>
            ...
            <h3 className="font-medium text-terminal-text mb-2">1.2 Data Minimization</h3>
            <p className="text-terminal-text leading-relaxed mb-4">
          ...
          {/* Section 2 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">2. Bank Connectivity</h2>

            <h3 className="font-medium text-terminal-text mb-2">2.1 How It Works</h3>
            <p className="text-terminal-text leading-relaxed mb-4">
              Bank account access is facilitated through Teller, a third-party financial data provider:
            </p>
            <ol className="list-decimal list-inside text-terminal-text space-y-1 ml-4 mb-4">
              <li>You authenticate directly with your bank via Teller Connect</li>
              ...
              <li>No ongoing access to your bank account is retained</li>
            </ol>

            <h3 className="font-medium text-terminal-text mb-2">2.2 Access Limitations</h3>
            <p className="text-terminal-text leading-relaxed mb-4">
              Our access to bank data is strictly limited:
            </p>
            <p className="text-terminal-text mb-2"><strong>What We Can Access:</strong></p>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4 mb-4">
              <li>Transaction history (read-only)</li>
              <li>Account balances (read-only)</li>
              <li>Account names and last 4 digits</li>
            </ul>
            <p className="text-terminal-text mb-2"><strong>What We Cannot Do:</strong></p>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4">
          ...
          {/* Section 3 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">3. Authentication & Authorization</h2>

            <h3 className="font-medium text-terminal-text mb-2">3.1 User Authentication</h3>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4 mb-4">
            ...
            <h3 className="font-medium text-terminal-text mb-2">3.2 Row Level Security (RLS)</h3>
            <p className="text-terminal-text leading-relaxed mb-4">
            ...
            <h3 className="font-medium text-terminal-text mb-2">3.3 Access Control</h3>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4">
              <li><strong>User:</strong> Can access only their own PNL reports and connected accounts</li>
              <li><strong>Public Reports:</strong> Can be accessed via unique shareable token (if enabled)</li>
          ...
          {/* Section 4 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">4. Data Retention</h2>

            <h3 className="font-medium text-terminal-text mb-2">4.1 Automatic Deletion</h3>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4 mb-4">
              <li><strong>PNL Report Data:</strong> Retained until user deletion</li>
            ...
            <h3 className="font-medium text-terminal-text mb-2">4.2 Manual Deletion</h3>
          ...
          {/* Section 5 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">5. GDPR Compliance</h2>

            <h3 className="font-medium text-terminal-text mb-2">5.1 Data Subject Rights</h3>
            <p className="text-terminal-text leading-relaxed mb-4">
              We support the following data subject rights under GDPR and similar regulations:
            </p>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4 mb-4">
              <li><strong>Right to Access:</strong> Export all data via account settings</li>
              ...
              <li><strong>Right to Rectification:</strong> Edit profile and account settings at any time</li>
            </ul>

            <h3 className="font-medium text-terminal-text mb-2">5.2 Data Export</h3>
            <p className="text-terminal-text leading-relaxed mb-4">
          ...
          {/* Section 6 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">6. Audit Logging</h2>
            <p className="text-terminal-text leading-relaxed mb-4">
              All significant actions are logged for security and compliance purposes:
            </p>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4 mb-4">
              <li>Report views (user ID, report ID, timestamp, IP address)</li>
              <li>Data exports (user ID, timestamp)</li>
              <li>Data deletions (user ID, what was deleted, timestamp)</li>
              <li>PNL report creation (user ID, account info, timestamp)</li>
          ...
          {/* Section 7 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">7. Infrastructure Security</h2>
            ...
            <h3 className="font-medium text-terminal-text mb-2">7.2 Network Security</h3>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4">
          ...
          {/* Section 8 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">8. Compliance & Certifications</h2>

            <h3 className="font-medium text-terminal-text mb-2">8.1 Standards We Follow</h3>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4 mb-4">
            ...
            <h3 className="font-medium text-terminal-text mb-2">8.2 Third-Party Security Certifications</h3>
            <ul className="list-disc list-inside text-terminal-text space-y-1 ml-4">
          ...
          {/* Section 9 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">9. Vulnerability Disclosure</h2>
            <p className="text-terminal-text leading-relaxed mb-4">
          ...
          {/* Section 10 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-terminal-text mb-4">10. Contact Information</h2>
            <p className="text-terminal-text leading-relaxed mb-4">
