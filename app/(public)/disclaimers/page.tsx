    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 md:p-12">
          ...
          {/* Section 2 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">2. No Financial Advice or Recommendations</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Section 3 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Not a Financial Institution</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Section 4 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">4. Source of Data & User Authorization</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Section 5 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Data Limitations & PNL Estimates</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
          ...
          {/* Section 9 */}
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">9. Responsibility of the User</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
