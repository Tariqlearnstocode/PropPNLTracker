  ...
  try {
    ...
    try {
      ...
      await resend.emails.send({
        from: FROM_EMAIL,
        to: [email],
        subject: 'Thank you for your interest in Prop Firm PNL Tracker Enterprise',
        html: `
          <!DOCTYPE html>
          <html>
            <head>
            ...
            <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
                ...
                <p style="font-size: 16px;">
                  Thank you for your interest in Prop Firm PNL Tracker Enterprise. Our team has received your inquiry and will reach out to you shortly to discuss your needs and provide a custom pricing quote.
                </p>
                ...
                <p style="font-size: 14px; color: #6b7280; margin-top: 30px;">
                  We look forward to helping you streamline your prop trading PNL tracking!
                </p>
              </div>
            </body>
          </html>
